...
{
	public class BorderedControlsConsole : ControlsConsole
	{
        TextSurface borderSurface;
        SurfaceEditor borderEdit;
		public BorderedControlsConsole(int width, int height) : base(width-1, height-1)
		{
        ...
        public BorderedControlsConsole(string title, int width, int height) : this(width, height)
        {
